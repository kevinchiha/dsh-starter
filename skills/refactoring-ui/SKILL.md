---
name: refactoring-ui
description: "Concrete design rules from the book Refactoring UI (Wathan and Schoger): constrained spacing, type, colour and shadow scales, hierarchy through weight and colour, depth through emulated light, plus a starter CSS token set. Use when a UI looks amateur and you need the principle behind the fix - too many font sizes, flat greys, muddy shadows, everything at one weight - or when a defensible scale is wanted instead of ad-hoc values."
---
